...
export const config = {
  ...
  PROFILE_ONBOARDING_URL: process.env.PROFILE_ONBOARDING_URL || 'http://profile-onboarding:3002',
  PLANNING_ENGINE_URL: process.env.PLANNING_ENGINE_URL || 'http://planning-engine:3003',
