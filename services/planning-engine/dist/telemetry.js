...
// 创建自定义Span工具函数
export const createBusinessSpan = (name, attributes = {}) => {
...
// 创建计划生成追踪
export const tracePlanGeneration = (userId, planData) => {
...
// 创建LLM调用追踪
export const traceLLMCall = (model, promptLength, userId) => {
...
// 创建数据库操作追踪
export const traceDatabaseOperation = (operation, table, userId) => {
